...
exports.normalizeTrueFalseValue = normalizeTrueFalseValue;
exports.validateAndSanitizeExam = validateAndSanitizeExam;
...
function normalizeTrueFalseValue(val) {
...
function validateAndSanitizeExam(examData) {
    const errors = [];
    ...
    const sanitizedPart1 = [];
    const sanitizedPart2 = [];
    const sanitizedPart3 = [];
    const sanitizedShared = [];
    // 1. VALIDATE PART 1 (MCQ)
    const seenP1Ids = new Set();
    let p1Index = 1;
...
//# sourceMappingURL=examValidation.js.map