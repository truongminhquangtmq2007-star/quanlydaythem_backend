...
const getStudentTopics = async (req, res) => {
    try {
        ...
        const result = await db_1.default.query(`SELECT 
             ...
             WHERE student_id = $1 
             ORDER BY accuracy_rate DESC, total_questions DESC`, [targetStudentId]);
        ...
        const jsonbRes = await db_1.default.query(`SELECT topic_performance 
             FROM exam_submissions 
             WHERE student_id = $1 AND status = 'COMPLETED' AND topic_performance IS NOT NULL 
             LIMIT 20`, [targetStudentId]);
