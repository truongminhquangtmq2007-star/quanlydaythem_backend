...
exports.aiTutorRateLimiter = void 0;
 ...
 */
const aiTutorRateLimiter = (req, res, next) => {
    let principalId;
    if (req.user?.id) {
...
exports.aiTutorRateLimiter = aiTutorRateLimiter;
//# sourceMappingURL=aiTutorRateLimiter.js.map